    ...
    <section className='max-w-7x-1'>
      ...
      <h1 className="font-extrabold text=[#222328] text-[32px]">
        ...
        [500px]">
          ...
          generated through DALL-E AI and share them through amongus
          </p>
      </div>
      ...
      <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <div className='relative bg-gray-50 border border-grey-
          300 text-gray-900 text-sm rounded-lg
